        ...
        return {
          ...
          _openAllPanels: function _openAllPanels() {
            ...
            this.panels.forEach(function (panel) {
              _this2.open(panel.getAttribute(_this2.panelAttribute));
            });
          },
          ...
          _setPanelDefaultStates: function _setPanelDefaultStates() {
            ...
            this.panels.forEach(function (panel) {
              _this3._panelShouldBeOpen(panel) ? _this3.open(panel.getAttribute(_this3.panelAttribute)) : _this3.close(panel.getAttribute(_this3.panelAttribute));
            });
          },
        ...
        return {
          ...
          _assignToggleIds: function _assignToggleIds() {
            ...
            this.childMenuToggleButtons.forEach(function (toggle) {
              Component.setAttributeIfNotSpecified(toggle, _this7.toggleAttribute, Component.generateUniqueId());
            });
          },
          ...
          _openAllChildMenus: function _openAllChildMenus() {
            ...
            this.childMenuToggleButtons.forEach(function (toggleButton, index) {
              ...
              _this8.childMenus[index].removeAttribute('hidden');
            });
          },
          ...
          _setChildMenuDefaultStates: function _setChildMenuDefaultStates() {
            ...
            this.childMenuToggleButtons.forEach(function (element, index) {
              if (element.getAttribute('aria-expanded') === 'true') {
                ...
                _this9.childMenus[index].setAttribute('hidden', '');
              }
            });
          },
        ...
        return {
          ...
          _assignTabIds: function _assignTabIds() {
            ...
            this.tabs.forEach(function (tab) {
              Component.setAttributeIfNotSpecified(tab, _this10.tabAttribute, Component.generateUniqueId());
          ...
          _deactivateUnselectedTabs: function _deactivateUnselectedTabs() {
            ...
            this.panels.forEach(function (panel, index) {
              if (!_this11._panelShouldBeActivated(panel)) {
                _this11._deactivateTab(panel, index);
              }
            });
          },
